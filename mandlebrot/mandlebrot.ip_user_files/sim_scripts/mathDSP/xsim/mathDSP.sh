...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_dsp48_macro_v3_0_17 -L xil_defaultlib -L secureip -L xpm --snapshot mathDSP xil_defaultlib.mathDSP -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mathDSP -key {Behavioral:sim_1:Functional:mathDSP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mathDSP.wdb xsim.dir)
